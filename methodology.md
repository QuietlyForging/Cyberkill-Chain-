...
![Lab Topology](assets/01_lab_topology.png)
...
![Palo Alto Security Rulebase](assets/02_attack_flow.png)
...
![Full port scan](assets/03_nmap_full_port_scan.png)
...
![Service and version scan](assets/04_nmap_service_version_scan.png)
...
![RDP encryption enumeration](assets/05_nmap_rdp_enum_encryption.png)
...
![Palo Alto traffic log — filtered on attacker source](assets/06_wazuh_decoder_rule.png)
...
![Wazuh custom rules XML](assets/07_wazuh_dashboard_alert.png)
...
![Raw alerts.json grep output](assets/08_alert_json_view1.png)
...
![Wazuh Discover — parsed alert fields](assets/09_alert_json_view2.png)
...
![Meterpreter session and file download, Kali desktop](assets/10_stage7_exfil_download.png)
...
![HTTP POST exfil captured on Kali](assets/12_stage7b_http_post_exfil.png)
...
![Wazuh/Sysmon detection of the PowerShell exfil command](assets/11_stage7b_wazuh_sysmon_detection.png)
